...
{
public:
	RecognitionController(pxcCHAR *title = 0)  {};
	...
	void calculatePointDistances(PXCFaceData::LandmarkPoint *points, float * distances, float x, float y, float z);
	void calculateAllDistances(PXCFaceData::LandmarkPoint *points);
